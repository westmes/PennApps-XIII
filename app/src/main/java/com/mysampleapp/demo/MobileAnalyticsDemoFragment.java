...
public class MobileAnalyticsDemoFragment extends DemoFragmentBase implements View.OnClickListener {

    private static final String LOG_TAG = MobileAnalyticsDemoFragment.class.getSimpleName();
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup container,
        ...
        final View retVal = inflater.inflate(R.layout.fragment_demo_mobile_analytics, container, false);
